...
ckpt_path = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/real_world_exp/2024-03-02/auto_train/142124.924132_seed4110/deploy_model"

# # jit version
# def load_dog_policy(logdir, cfg):
#     body = torch.jit.load(ckpt_path + '/body_latest_dog.jit')
#     adaptation_module = torch.jit.load(ckpt_path + '/adaptation_module_latest_dog.jit')
...
#     body = torch.jit.load(ckpt_path + '/body_latest_arm.jit')
#     adaptation_module = torch.jit.load(ckpt_path + "/adaptation_module_latest_arm.jit")
...
def load_dog_policy(logdir, Cfg):
    ...
    ckpt = torch.load("/home/pi7113t/controller/hybrid/walk-these-ways/runs/RR3778NN/2024-03-07/auto_train/000030.461157_seed3778/checkpoints_dog/ac_weights_009600.pt", map_location=device)
...
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/real_world_exp/2024-03-02/auto_train/142124.924132_seed4110"
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/funny/auto_train_ablation"
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/test_woimmediate/2024-03-03/auto_train/220627.553739_seed3900"
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/G2HT3778/2024-03-05/auto_train/163750.352951_seed3778"
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/A1HT3778/2024-03-06/auto_train/000641.376671_seed3778"
logdir = "/home/pi7113t/controller/hybrid/walk-these-ways/runs/ablation/HT1371"
...
def load_env(logdir, headless=False):
    ...
    Cfg.arm.commands.roll_ee = [torch.pi/4, torch.pi/4]
    Cfg.arm.commands.pitch_ee = [torch.pi/4, torch.pi/4]
    Cfg.arm.commands.yaw_ee = [torch.pi/4, torch.pi/4]
