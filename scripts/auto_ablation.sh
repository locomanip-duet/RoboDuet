...
screen -dmS TwoStage_Seed5078 bash -c "source ~/miniconda3/etc/profile.d/conda.sh && conda activate isaacgym && python scripts/unified_train.py --num_envs 4096 --seed 5078 --run_name TwoStage --sim_device cuda:5 > screen_log/TwoStage_Seed5078.log; exec bash"
